        ...
        if (!f) {
            ...
            f.Mc = f.u.R({
                ua: 1, Q: function () {
                    ...
                    b = ['<svg width="' + b + '" height="' + c + '" xmlns="https://www.w3.org/2000/svg"><defs><linearGradient id="g" gradientUnits="userSpaceOnUse" x1="' + a / b * 100 + '%" y1="' + i / c * 100 + '%" x2="' + h / b * 100 + '%" y2="' + k / c * 100 + '%">'];
            ...
            f.Nc = f.u.R({
                T: "repeat", Sc: "stretch", Qc: "round", ua: 0, Q: function () {
                    ...
                    f.p.Rb(b.src, function (k) {
                        ...
                        k = ['<svg width="' + m + '" height="' + p + '" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink">'];
            ...
            f.kb = function () {
                ...
                var e = {}, g = f.F + "lazy-init", j = f.F + "poll", i = f.F + "track-active", h = f.F + "track-hover", k = f.La + "hover", n = f.La + "active", m = f.La + "focus", p = f.La + "first-child", r = {
                    background: 1,
                    bgColor: 1,
                    display: 1
                }, t = {}, v = [];
 ...
 * https://imakewebthings.com/jquery-waypoints/
 */
(function () {
...
/*!
 * Lettering.js - 0.7.0
 * httpss://github.com/davatron5000/Lettering.js
 */
(function ($) {
 ...
 * httpss://github.com/aishek/jquery-animateNumber
 */
(function (d) {
    var p = function (b) {
 ...
 * httpss://github.com/sdecima/javascript-detect-element-resize
 */
(function () {
    ...
    if (!attachEvent) {
        ...
        var animation = false, animationstring = 'animation', keyframeprefix = '', animationstartevent = 'animationstart', domPrefixes = 'Webkit Moz O ms'.split(' '), startEvents = 'webkitAnimationStart animationstart oAnimationStart MSAnimationStart'.split(' '), pfx = '';
        {
...
/*!
 * waitForImages - 2.0.0
 * httpss://github.com/alexanderdickson/waitForImages
 */
;(function (factory) {
    if (typeof define === 'function' && define.amd) {
...
window.Modernizr = (function (window, document, undefined) {
    var version = '2.8.3', Modernizr = {}, enableClasses = true, docElement = document.documentElement, mod = 'modernizr', modElem = document.createElement(mod), mStyle = modElem.style, inputElem = document.createElement('input'), smile = ':)', toString = {}.toString, prefixes = ' -webkit- -moz- -o- -ms- '.split(' '), omPrefixes = 'Webkit Moz O ms', cssomPrefixes = omPrefixes.split(' '), domPrefixes = omPrefixes.toLowerCase().split(' '), ns = {'svg': 'https://www.w3.org/2000/svg'}, tests = {}, inputs = {}, attrs = {}, classes = [], slice = classes.slice, featureName, injectElementWithStyles = function (rule, callback, nodes, testnames) {
...
/*!
 * carousel-3d - 0.2.0
 * https://paio-co-kr.github.io/carousel-3d/
 */
!function a(b, c, d) {
    function e(g, h) {
        if (!c[g]) {
    ...
    1: [function (a) {
        !function () {
            ...
            e.prototype.el = null, e.prototype.option = {animationDuration: 1e3}, e.prototype._makeOption = function () {
                (function () {
                    var a = b("<div data-children-wrapper></div>").hide().appendTo(this.el), c = b("<div data-child></div>").hide().appendTo(a).css("transition-duration");
            ...
            c.prototype.el = null, c.prototype._carousel3dObj = null, c.prototype._childObjArray = [], c.prototype._currentIndex = 0, c.prototype._tz = 0, c.prototype._spacing = .05, c.prototype.currentIndex = function (a) {
                ...
                if (Modernizr.csstransforms3d)for (d = 0; d < this._childObjArray.length; d += 1) {
                    ...
                    var g = a(this.el).width(), h = a(this.el).height(), i = function (b, d) {
                        if ("_degree" === d.prop) {
                            var e = Math.sin(Math.PI / 180 * b), f = Math.cos(Math.PI / 180 * b), i = c / 2, j = Math.abs(Math.sin(Math.PI / 180 * (b + i)) - Math.sin(Math.PI / 180 * (b - i))) / (2 * Math.sin(Math.PI / 180 * i)) * f, k = (f + 1) / 2, l = (j + 1) / 2, m = (e * g / 2 + g * l / 2 * e) / 2;
        ...
        utils: {
            ...
            maps: function () {
                ...
                if ($('#mapa').size()) {
                    ...
                    mapOptions = {
                        zoom: 16,
                        center: new google.maps.LatLng(49.001200, 8.429708),
                    ...
                    if ($('html').hasClass('theme-a')) {
                        markerOpts = {
                            position: new google.maps.LatLng(49.003213, 8.423008),
                            map: mapa,
            ...
            responsive: function () {
                if (!$.browser.mobile) {
                    ...
                    $(window).each(function () {
                        ...
                        }, {offset: -$('#featured, #getapp').outerHeight()});
                    });
            ...
            miscellaneous: function () {
                ...
                $('#top').each(function () {
                    $(this).clone().attr('id', 'clone').insertAfter('#featured, #getapp').find('#nav').removeAttr('id').parent().find('#skip').remove();
                });
                ...
                $('html[data-pattern]').each(function () {
                    $(this).find('#getapp, #featured, #content.a > .vb').addClass('data-pattern').css('background-image', 'url(' + $(this).attr('data-pattern') + ')')
                });
                $('.counter .v').lettering();
...
/*! Twitter Fetcher disabled for now*/
